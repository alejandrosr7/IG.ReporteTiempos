...
public interface IRestClient {
    ...
    Object User(@Body Login Credenciales);
    ...
    List<ClassificationConceptHour> GetClassificationConceptHour(@Query("CodigoTipoHora") int
                                                                         codeTypeHour);
    ...
    List<functionality> Getfunctionality(@Query("Id") int codeProyect, @Query("soloActivos") int
            soloActivos, @Query("IdFuncionalidadActual") int IdFuncionalidadActual);
    ...
    List<Discipline> getActivityDisciplineStimationForRegister(@Query("codigoFuncionalidad") int
                                                                       code);


    @GET("/Consultas/ConsultarFuncionalidadActividadesEstimadasParaRegistro")
    List<ActivityDiscipline> getFuncionalityActivityStimateForRegister(@Query("codigoDisciplina")
                                                                               int
                                                                               codeDiscipline,
                                                                       @Query("codigoFuncionalidad")
    ...
    List<ResumTimesForCollaborator> GetResumTimesForCollaborator(@Query("CodigoEmpleado") String
                                                                         userCode);


    @GET("/ReporteGerente/ConsultarTiempoColaboradorGerente")
    List<TimesForManager> GetTimesForManager(@Query("CodigoGerente") String idManagerCode, @Query
            ("FechaInicio") String startDate, @Query("FechaFin") String finishDate);
    ...
    List<ViewTimesManagerDetail> GetTimesManagerDetail(@Query("CodigoGerente") String
                                                               idManagerCode, @Query
                                                               ("FechaInicio") String startDate,
                                                       @Query("FechaFin") String finishDate);
