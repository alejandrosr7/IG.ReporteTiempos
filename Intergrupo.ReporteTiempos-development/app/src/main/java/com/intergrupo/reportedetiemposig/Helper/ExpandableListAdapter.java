...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapter(Context context,ArrayList<HashMap> listDataHeader, HashMap<String, ArrayList<ViewTimesModel>> listChildData) {
                ...
                for(ViewTimesModel activity: activityList ){
                    ...
                    try {
                        ...
                        if(!query.isEmpty() && fecha != null){
                            if((activity.getDescripcion().toString().toLowerCase().contains(query) || activity.getCodigoActividad().toString().toLowerCase().contains(query)) && (fechaList.getTime() >= fecha.get(0).getTime() &&  fechaList.getTime() <= fecha.get(1).getTime())){
                            ...
                            if(!query.isEmpty()){
                                if((activity.getDescripcion().toString().toLowerCase().contains(query) || activity.getCodigoActividad().toString().toLowerCase().contains(query)) && (fechaList.getTime() >= fromDate.getTime() && fechaList.getTime() <= toDate.getTime()) ){
                                    newList.add(activity);
                                }
                                    ...
                                    if(fechaList.getTime() >= fromDate.getTime() && fechaList.getTime() <= toDate.getTime()){
                                        ...
                                        try {
                                            dateString = activity.getFechaActividad();
                                            fechaList = formatter.parse(dateString);
                                            if(fechaList.getTime() >= fecha.get(0).getTime() &&  fechaList.getTime() <= fecha.get(1).getTime()){
                                                newList.add(activity);
                                            }
